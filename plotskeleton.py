...
class plotSkeleton(object):
    ...
    def __init__(self,data,boneConnection,dataHeader,JointID1=1,\
...
if __name__ == '__main__':
    data,dataHeader,orient,orientHead,_,_ = fio.readDataFile('Data/test_Data.csv')
    boneConnection = [orient[0,0::8][1:],orient[0,1::8][1:]]
    a = plotSkeleton(data,boneConnection,dataHeader)#,startEndTime=[5000,15000])
    a.show()